...
<title>Delivery on the Date</title>
<link rel="stylesheet" 
...
<body >
<header>
                <nav class="navbar navbar-light" style="background-color: #9FF781;"> <span class="navbar-brand mb-0 h3"><strong>DELIVERY PRODUCTS</strong></span>
						</nav> 
